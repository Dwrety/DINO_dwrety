...
from data.structures.boxlist_ops import boxlist_iou
...
def do_coco_evaluation(
    ...
    if box_only:
        ...
        logger.info(res)
        check_expected_results(logger, res, expected_results, expected_results_sigma_tol)
        if output_folder:
    ...
    logger.info(results)
    check_expected_results(logger, results, expected_results, expected_results_sigma_tol)
    if output_folder:
...
def check_expected_results(logger, results, expected_results, sigma_tol):
